...
export const CartProvider = ({children}) => {
    ...
    const updateCartItemsReducer = (newCartItems) => {
        const newCartCount = newCartItems.reduce((numItems, currentItem) => numItems + currentItem.quantity ,0)
        const newCartTotal = newCartItems.reduce((numItems, currentItem) => numItems + currentItem.quantity * currentItem.price  ,0)
